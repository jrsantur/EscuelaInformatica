...
public class Recursividad extends ActionBarActivity {
private TextView txttitulo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recursividad);
        txttitulo=(TextView)findViewById(R.id.txttituloRecursividad);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_recursividad, menu);
        return true;
    }
